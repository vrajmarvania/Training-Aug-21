<template>
    ...
    <div class="item3">
        ...
        <!-- CSS Selectors(id selectors, class selectors, element selectors) -->
        <!-- The CSS element Selector -->
        <h4>CSS Selectors</h4>
        <h4>CSS Selectors</h4>
        <h3 id="e1">CSS Selectors</h3>
        <h3 class="e2">CSS Selectors</h3>
        <h2 class="e2 e3">CSS Selectors</h2>
        <h3>CSS Selectors</h3>
        ...
        <h3 id="left">Text Alignment</h3>
        <h3 id="center">Text Alignment</h3>
        <h3 id="right">Text Alignment</h3>
        ...
        <p id="p">In my younger and more vulnerable years my father gave me some advice that I've been turning over in my
            mind ever since. 'Whenever you feel like criticizing anyone,' he told me, 'just remember that all the people in
