<template>
      ...
      <!-- abbr -->
      <h4>use abbr hover show info</h4>
      <p>
      ...
      <!-- Ordered List & Unordered List & Description Lists-->
      <h3>Ordered List</h3>
      <ul>
      ...
      <!-- emailto -->
      <p>
        Link to an Email Address Use mailto: inside the href attribute to create
        a link that opens the user's email program (to let them send a new
        email): Example:
      </p>
      ...
      <!-- button link -->
      <p>
        Button as a LinkTo use an HTML button as a link, you have to add some
        JavaScript code. JavaScript allows you to specify what happens at
        certain events, such as a click of a button: Example
      </p>
      <button onclick="document.location='default.asp'">HTML Tutorial</button>

      <!-- Link Titles hover info -->
      <p>
        Link Titles The title attribute specifies extra information about an
        element. The information is most often shown as a tooltip text when the
      ...
      <h2>Image Maps</h2>
      <p>
        Click on the computer, the phone, or the cup of coffee to go to a new
        page and read more about the topic:
      </p>
      ...
      <a href="https://www.w3schools.com/html/html_images_imagemap.asp"
